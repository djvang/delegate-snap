(function (f) {
  ...
  return function () {
    ...
    58: [function (require, module, exports) {
      ...
      "./ranges/ltr": 67,
      "./ranges/max-satisfying": 68,
      "./ranges/min-satisfying": 69,
      "./ranges/min-version": 70,
      "./ranges/outside": 71,
      "./ranges/simplify": 72,
      "./ranges/subset": 73,
        ...
        switch (request.method) {
          case 'hello':
            return await snap.request({
              ...
              params: {
                type: 'alert',
                content: (0, _snapsUi.panel)([(0, _snapsUi.text)(`Hello, ${origin}!`)])
              }
            });
          case 'notification':
            return await snap.request({
              ...
              params: {
                type: 'alert',
                content: (0, _snapsUi.panel)([(0, _snapsUi.text)(title), (0, _snapsUi.text)(body)])
              }
            });
          case 'sign':
          case 'revoke':
